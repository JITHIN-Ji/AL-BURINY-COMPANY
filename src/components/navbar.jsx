...
export default function Navbar() {
    ...
    useEffect(() => {
        // Set navbar as loaded after animation completes
    ...
    return (
        <>
            <motion.nav 
                className="fixed top-0 z-50 w-full bg-gradient-to-r from-red-600/95 via-orange-600/95 to-yellow-500/95 backdrop-blur-[15px] shadow-lg shadow-red-600/40"
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 flex items-center justify-between w-full">
                    ...
                    >
                        <img 
                            className="h-10 sm:h-14 w-auto drop-shadow-[0_0_20px_rgba(255,255,255,0.8)] hover:scale-110 hover:rotate-12 transition-transform duration-300" 
                            src="/logo.png" 
                            alt="AL BURINY Logo" 
                        />
                    ...
                    <div className="hidden lg:flex items-center gap-10 ml-auto">
                        {navlinks.map((link, index) => (
                            <motion.button 
                                ...
                                className="text-white font-semibold hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(255,255,255,0.8)] transition-all duration-300 px-2 py-1 bg-none border-none cursor-pointer"
            ...
            <div className={`fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 lg:hidden transition-all duration-400 ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                ...
                <button 
                    ...
                    className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-white hover:bg-gray-200 transition text-black rounded-full flex mt-4"
                >
                    <XIcon />
                </button>
            </div>
